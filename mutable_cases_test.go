...
type mutableIntTestArgs = testArgs[Mutable[int], int]
type mutableIntTestCase = testCase[Mutable[int], int]
type mutableIntTestBuilder = testCollectionBuilder[Mutable[int], int]
